...
import boto3
from src.processors.backup.update_processor import EventProcessor
...
class TestEventProcessor:
    ...
    def test_extract_data_missing_payload(self, sample_missing_payload_event):
    ...
    def test_extract_data_direct_payload(self):
        """Tests extraction with direct payload (no body)."""
        event = {
            "payload": {
                "id": "456",
                "user": {"name": "Jane Doe"},
